...
const FileCard = React.memo(function FileCard({
  ...
  if (variant === "compact") {
    ...
    return (
      <div className="flex items-center justify-between bg-white p-2 rounded-lg border border-slate-200/80 text-[12.5px]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onRemove && (
            <button
              type="button"
              onClick={onRemove}
              className="text-slate-400 hover:text-rose-500 p-0.5 hover:bg-rose-50 rounded transition-colors"
            >
  ...
  return (
    <a
      ...
      className="flex items-center p-3.5 rounded-xl border border-slate-100 hover:border-[#6C1D5F]/30 hover:bg-slate-50/50 transition-colors group cursor-pointer"
    >
