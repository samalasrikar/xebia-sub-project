      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <input
              className="w-full bg-slate-50/50 border border-slate-200 rounded-lg px-3 py-2 text-[13px] text-slate-700 outline-none focus:border-[#6C1D5F] transition-colors"
              type="date"
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className={`w-10 h-5 rounded-full relative transition-colors ${formData.allowLate ? "bg-[#6C1D5F]" : "bg-slate-200"}`}
          >
            <div
