    ...
    <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm relative overflow-hidden">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            className="w-full bg-slate-50/50 border border-slate-200 rounded-lg px-4 py-2.5 text-[14px] text-slate-800 placeholder-slate-400 focus:border-[#6C1D5F] focus:ring-1 focus:ring-[#6C1D5F] outline-none transition-colors"
            id="assignment-title"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <select
              className="w-full bg-slate-50/50 border border-slate-200 rounded-lg px-4 py-2.5 text-[14px] text-slate-700 focus:border-[#6C1D5F] focus:ring-1 focus:ring-[#6C1D5F] outline-none transition-colors"
              id="assignment-type"
              value={formData.type}
            ...
            >
              ...
              <option value="pdf">Document Submission (PDF)</option>
          ...
          <div>
            ...
            <input
              className="w-full bg-slate-50/50 border border-slate-200 rounded-lg px-4 py-2.5 text-[14px] text-slate-800 focus:border-[#6C1D5F] focus:ring-1 focus:ring-[#6C1D5F] outline-none transition-colors"
              id="max-marks"
              min="0"
              type="number"
        ...
        <div>
          ...
          <textarea
            className="w-full bg-slate-50/50 border border-slate-200 rounded-lg px-4 py-2.5 text-[14px] text-slate-800 placeholder-slate-400 focus:border-[#6C1D5F] focus:ring-1 focus:ring-[#6C1D5F] outline-none transition-colors resize-y"
            id="instructions"
